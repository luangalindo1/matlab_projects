...
% QUESTÃO 3: MATRIZES DE REDE E FLUXO DE POTÊNCIA: Método de Newton na forma polar
...
% Elementos da diagonal principal da matriz de impedancio 
Z11 = ((1/Z12)+(1/Z13))^-1;
Z22 = ((1/Z12)+(1/Z23)+(1/Z24)+(1/Z25))^-1;
Z33 = ((1/Z13)+(1/Z23)+(1/Z34))^-1;
Z44 = ((1/Z24)+(1/Z34)+(1/Z45))^-1;
Z55 = ((1/Z25)+(1/Z45))^-1;
Z = [Z11 0 0 0 0; 0 Z22 0 0 0 ; 0 0 Z33 0 0; 0 0 0 Z44 0;0 0 0 0 Z55];
...
TENSOES = table(iter_vec', V_barra(:,1), teta_barra(:,1), V_barra(:,2),...
               teta_barra(:,2), V_barra(:,3),teta_barra(:,3),V_barra(:,4),teta_barra(:,4));    
